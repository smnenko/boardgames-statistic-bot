...
class Board(peewee.Model):
    ...
    created_at = DateTimeField(default=datetime.datetime(2022, 10, 27, 12, 30, 37, 583672))
    updated_at = DateTimeField(default=datetime.datetime(2022, 10, 27, 12, 30, 37, 583678))
    class Meta:
        table_name = "board"
...
class Game(peewee.Model):
    ...
    created_at = DateTimeField(default=datetime.datetime(2022, 10, 27, 12, 30, 37, 584011))
    updated_at = DateTimeField(default=datetime.datetime(2022, 10, 27, 12, 30, 37, 584016))
    class Meta:
        table_name = "game"
...
class GameResult(peewee.Model):
    ...
    created_at = DateTimeField(default=datetime.datetime(2022, 10, 27, 12, 30, 37, 584291))
    updated_at = DateTimeField(default=datetime.datetime(2022, 10, 27, 12, 30, 37, 584296))
    class Meta:
...
class GameRole(peewee.Model):
    ...
    created_at = DateTimeField(default=datetime.datetime(2022, 10, 27, 12, 30, 37, 584155))
    updated_at = DateTimeField(default=datetime.datetime(2022, 10, 27, 12, 30, 37, 584159))
    class Meta:
        table_name = "gamerole"
...
class User(peewee.Model):
    ...
    created_at = DateTimeField(default=datetime.datetime(2022, 10, 27, 12, 30, 37, 583481))
    updated_at = DateTimeField(default=datetime.datetime(2022, 10, 27, 12, 30, 37, 583489))
    class Meta:
        table_name = "user"
...
class Profile(peewee.Model):
    ...
    created_at = DateTimeField(default=datetime.datetime(2022, 10, 27, 12, 30, 37, 583857))
    updated_at = DateTimeField(default=datetime.datetime(2022, 10, 27, 12, 30, 37, 583863))
    class Meta:
        table_name = "profile"
...
class ProfileResult(peewee.Model):
    ...
    created_at = DateTimeField(default=datetime.datetime(2022, 10, 27, 12, 30, 37, 584448))
    updated_at = DateTimeField(default=datetime.datetime(2022, 10, 27, 12, 30, 37, 584453))
    class Meta:
